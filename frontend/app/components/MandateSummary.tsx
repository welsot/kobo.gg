...
type MandateSummaryProps = {
  mandate: MandateDto;
  className?: string;
};

export function MandateSummary({ mandate, className = '' }: MandateSummaryProps) {
  return (
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            <div>
              <span className="font-medium">Status:</span> {mandate.status}
            </div>
        ...
        {mandate.contactInfo && (
          <div className="mt-4 pt-4 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <span className="font-medium">Name:</span> {mandate.contactInfo.name}
              </div>
              <div>
                <span className="font-medium">Email:</span> {mandate.contactInfo.email}
              </div>
              {mandate.contactInfo.phone && (
                <div>
                  <span className="font-medium">Phone:</span> {mandate.contactInfo.phone}
                </div>
              )}
            </div>
          </div>
