...
export function meta({}: Route.MetaArgs) {
  ...
  const url = `${baseUrl}/how-to-send-epub-books-to-kindle`;

  return [
    { title: "How to Transfer eBooks to Your Kindle eReader - Complete Guide " + year },
    { name: "description", content: "Learn how to easily transfer multiple ePUB and PDF books to your Kindle eReader in 6 simple steps. No account required, completely anonymous uploads." },
    { name: "viewport", content: "width=device-width,initial-scale=1" },
    { name: "keywords", content: "kindle ebook transfer, epub to kindle, kindle ereader books, transfer books kindle, kindle sideload, epub upload" },

    // Open Graph / Facebook
    { property: "og:type", content: "article" },
    { property: "og:url", content: url },
    { property: "og:title", content: "How to Transfer eBooks to Your Kindle eReader - Step by Step Guide" },
    { property: "og:description", content: "Simple 6-step guide to transfer multiple ePUB and PDF books to your Kindle eReader. Anonymous uploads, no registration needed." },
    { property: "og:image", content: `${baseUrl}/kobogg-screenshot.png` },

    // Twitter
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:url", content: url },
    { name: "twitter:title", content: "How to Transfer eBooks to Your Kindle eReader - Complete Guide" },
    { name: "twitter:description", content: "Learn how to easily transfer multiple ePUB and PDF books to your Kindle eReader in 6 simple steps." },
...
export default function HowToKindle() {
  const year = new Date().getFullYear();
          ...
          <article className="max-w-4xl mx-auto px-4 py-8">
            ...
            <header className="mb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
                How to Transfer Multiple eBooks to Your Kindle eReader
              </h1>
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                The simplest way to upload and transfer ePUB and PDF books to your Kindle device in just 6 easy steps.
            ...
            <section className="mb-10">
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                If you're looking for a quick and secure way to transfer multiple eBooks to your Kindle eReader,
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700 mb-3">
                      On your Kindle eReader, go to "More" {'=>'} "Beta Features" {'=>'} "Web Browser" and open the built-in web browser, navigate to <strong>kobo.gg</strong>.
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-purple-50 p-6 rounded-lg">
                  ...
                  <p className="text-purple-700 text-sm">
                    Compatible with Kindle, Kobo and other eReaders with web browser capabilities.
                  </p>
                </div>
            ...
            <section className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-8 rounded-lg text-center">
              ...
              <p className="text-lg mb-6 text-purple-100">
                Start transferring your eBook collection to your Kindle eReader in just a few clicks.
              </p>
              <a
                  href="/"
